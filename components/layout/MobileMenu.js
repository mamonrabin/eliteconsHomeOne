            ...
            <div className="mobile-nav__wrapper">
                ...
                <div className="mobile-nav__content">
                    ...
                    <div className="logo-box">
                        <Link href="/" aria-label="logo image"><img src="assets/images/resources/logo2.png" width="50" alt="" /></Link>
                    </div>
                    ...
                    <ul className="mobile-nav__contact list-unstyled">
                        <li>
                            ...
                            <Link href="mailto:needhelp@elitecons.com">almamon757@gmail.com</Link>
                        </li>
                        <li>
