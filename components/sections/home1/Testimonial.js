                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-6 col-lg-6">
                                            <div className="testimonial-one__img">
                                                <img src="assets/images/testimonial/testimonial01.jpg" alt=""/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="swiper-slide">
                                <div className="testimonial-one__single">
                                    <div className="row">
                                        ...
                                        <div className="col-xl-6 col-lg-6">
                                            <div className="testimonial-one__img">
                                                <img src="assets/images/testimonial/testimonial02.jpg" alt=""/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="swiper-slide">
                                <div className="testimonial-one__single">
                                    <div className="row">
                                        ...
                                        <div className="col-xl-6 col-lg-6">
                                            <div className="testimonial-one__img">
                                                <img src="assets/images/testimonial/testimonial03.jpg" alt=""/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
