                        ...
                        <div className="project-one__single-box">
                            <ul className="project-one__box list-unstyled">
                                ...
                                <li>
                                    <div className="project-one__box-content">
                                        <div className="single-project-one__bg"
                                            style={{ backgroundImage: 'url(assets/images/backgrounds/project01.jpg' }} >
                                        </div>
                                    </div>
                                </li>
                                </SwiperSlide>
                                ...
                                <li className="active">
                                    <div className="project-one__box-content">
                                        <div className="single-project-one__bg"
                                            style={{ backgroundImage: 'url(assets/images/backgrounds/project02.jpg' }} >
                                        </div>
                                    </div>
                                </li>
                                </SwiperSlide>
                                ...
                                <li>
                                    <div className="project-one__box-content">
                                        <div className="single-project-one__bg"
                                            style={{ backgroundImage: 'url(assets/images/backgrounds/project03.jpg' }} >
                                        </div>
                                    </div>
                                </li>
                                </SwiperSlide>
