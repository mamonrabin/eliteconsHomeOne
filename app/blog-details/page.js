                        ...
                        <div className="blog-details__left">
                            <div className="blog-details__img-box">
                                <div className="blog-details__img">
                                    <img src="assets/images/blog/blogdetailsimg1.jpg" alt=""/>
                                </div>
                            ...
                            <div className="blog-details__content">
                                ...
                                <div className="blog-details__img-and-content">
                                    <div className="blog-details__text-img">
                                        <img src="assets/images/blog/blogdetailscontentimg.jpg" alt=""/>
                                    </div>
                            ...
                            <div className="comment-one">
                                ...
                                <div className="comment-one__single">
                                    ...
                                    <div className="comment-one__content">
                                        <h3>Stanio lainto<span>December 16, 2025</span></h3>
                                ...
                                <div className="comment-one__single comment-one__single-2">
                                    ...
                                    <div className="comment-one__content">
                                        <h3>Court Henry<span>December 16, 2025</span></h3>
                                        <div className="comment-one__social">
                                            <Link href="#"><span className="icon-facebook"></span></Link>
                                            <Link href="#"><span className="icon-twitter"></span></Link>
                                            <Link href="#"><span className="icon-instagram"></span></Link>
                                ...
                                <ul className="sidebar__post-list list-unstyled">
                                    <li>
                                        <div className="sidebar__post-image">
                                            <img src="assets/images/blog/lp1.jpg" alt=""/>
                                        </div>
                                    ...
                                    <li>
                                        <div className="sidebar__post-image">
                                            <img src="assets/images/blog/lp2.jpg" alt=""/>
                                        </div>
                                        <div className="sidebar__post-content">
                                            <h3>
                                    ...
                                    <li>
                                        <div className="sidebar__post-image">
                                            <img src="assets/images/blog/lp3.jpg" alt=""/>
                                        </div>
                                        <div className="sidebar__post-content">
                                            <h3>
