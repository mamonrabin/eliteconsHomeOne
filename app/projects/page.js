                    ...
                    <div className="row">
                            ...
                            <div className="project-three__single">
                                <div className="project-three__img-box">
                                    <div className="project-three__img">
                                        <img src="assets/images/project/project31.jpg" alt=""/>
                                    </div>
                                </div>
                                <div className="project-three__content">
                                    ...
                                    <div className="project-three__plus">
                                        <Link href="/project-details" className="img-popup"><span
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="project-three__single">
                                <div className="project-three__img-box">
                                    <div className="project-three__img">
                                        <img src="assets/images/project/project32.jpg" alt=""/>
                                    </div>
                                </div>
                                <div className="project-three__content">
                                    <div className="project-three__title-box">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="project-three__single">
                                <div className="project-three__img-box">
                                    <div className="project-three__img">
                                        <img src="assets/images/project/project33.jpg" alt=""/>
                                    </div>
                                </div>
                                <div className="project-three__content">
                                    <div className="project-three__title-box">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="project-three__single">
                                <div className="project-three__img-box">
                                    <div className="project-three__img">
                                        <img src="assets/images/project/project34.jpg" alt=""/>
                                    </div>
                                </div>
                                <div className="project-three__content">
                                    <div className="project-three__title-box">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="project-three__single">
                                <div className="project-three__img-box">
                                    <div className="project-three__img">
                                        <img src="assets/images/project/project35.jpg" alt=""/>
                                    </div>
                                </div>
                                <div className="project-three__content">
                                    <div className="project-three__title-box">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="project-three__single">
                                <div className="project-three__img-box">
                                    <div className="project-three__img">
                                        <img src="assets/images/project/project36.jpg" alt=""/>
                                    </div>
                                </div>
                                <div className="project-three__content">
                                    <div className="project-three__title-box">
