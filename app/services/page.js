        ...
        <section className="services-page">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-4 cursor-pointer col-md-6">
                        <div className="services-four__single">
                            <div className="services-four__img">
                                <img src="assets/images/services/services4.jpg" alt=""/>
                            </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-four__single">
                            <div className="services-four__img">
                                <img src="assets/images/services/services5.jpg" alt=""/>
                            </div>
                            <div className="services-four__content">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-four__single">
                            <div className="services-four__img">
                                <img src="assets/images/services/services6.jpg" alt=""/>
                            </div>
                            <div className="services-four__content">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-four__single">
                            <div className="services-four__img">
                                <img src="assets/images/services/services7.jpg" alt=""/>
                            </div>
                            <div className="services-four__content">
                                <h5 className="services-four__title"><Link href="service-details">Pixel Craft</Link>
                                </h5>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-four__single">
                            <div className="services-four__img">
                                <img src="assets/images/services/services8.jpg" alt=""/>
                            </div>
                            <div className="services-four__content">
                                <h5 className="services-four__title"><Link href="service-details">Pro Build
                                        Innovations</Link>
